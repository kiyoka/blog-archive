...
やっと、*[http://github.com/tenderlove|tenderlove*]ことAaron Patterson氏が書かれたブログエントリでメカニズムが理解できた。

## Aaron Patterson氏の説明を読み解く
 *[http://blog.rubygems.org/2011/08/31/shaving-the-yaml-yacc.html|Shaving a YAML Yack | RubyGems.org*]
