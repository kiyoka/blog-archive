...
話としては([Kyoto.Lisp Hackathon でやったことのまとめ](/blog-archive/2012/08/11/summary-of-what-we-did-at-kyoto-lisp-hackathon/)) の続き。
...
pureのアイデアについてはこちらの過去記事を参照のこと。
 [コードブロックに副作用が混在するかを検出できるかどうか](/blog-archive/2011/10/07/is-it-possible-to-detect-if-a-code-block-contains-mixed-side-effects/)
