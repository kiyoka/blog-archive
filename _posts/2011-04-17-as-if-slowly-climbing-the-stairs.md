...
過去に「[syntax-rulesが動いた日](/blog-archive/2011/04/06/the-day-syntax-rules-worked/)」でdefine-syntaxとdefine-rulesが動いた話を書いたが、let-syntaxを実現しようと思ったらだいぶ書き直さないといけないだろう。
